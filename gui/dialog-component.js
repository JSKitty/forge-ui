...
window.onload = function(){
  ...
  let componentStyleHtml = '.component_mask{' +
    ...
    '.component_dialog {' +
    'position: fixed;z-index: 9999;min-width: 300px;top: 50%;left: 41%;' +
    '-webkit-transform: translate(-50%, -50%);transform: translate(-50%, -50%);background-color: #fafafc;' +
    'text-align: center;border-radius: 12px;margin-left:160px;}' +
    ...
    '.component_dialog_bd {' +
    'padding: 0 20px;font-size: 15px;color: #888;word-wrap: break-word;}' +
    '.component_dialog_ft {' +
