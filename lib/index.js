...
function approveItem(item) {
    ...
    item.objLastValidation.successful = true;
    item.objLastValidation.consequtiveFailures = 0;
    ...
    for (let i=0; i<itemsToValidate.length; i++) {
        if (item.strTx === itemsToValidate[i].strTx) {
            wasFound = true;
            itemsToValidate[i].objLastValidation.successful = true;
            itemsToValidate[i].objLastValidation.consequtiveFailures = 0;
        ...
        if (item.strTx === unsignedItems[i].strTx) {
            if (item.strSig && !unsignedItems[i].strSig) {
                if (item.strSig.length > 0) {
                    ...
                    unsignedItems[i].objLastValidation.successful = true;
                    unsignedItems[i].objLastValidation.consequtiveFailures = 0;
    ...
    for (i=0; i<len; i++) {
        ...
        if (item.strTx === items[i].strTx) {
            ...
            if (cItem.getValidityLevel() >= ValidityLevel.PENDING) {
                ...
                console.error(cItem.objLastValidation.consequtiveFailures);
